    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    err_1 = _a.sent();
                    log("Process creation failed :  ".concat(JSON.stringify(err_1, null, 2)));
                    return [3 /*break*/, 4];
                case 4:
                    // ---------------------------------------------------------------------------------------
                    //claim human task
                    ...
                    setInterval(function () { return __awaiter(_this, void 0, void 0, function () {
                        var log, taskListRes, taskClaimed, err_2;
                        var _this = this;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                ...
                                case 3:
                                    err_2 = _a.sent();
                                    log("getTasks error ".concat(JSON.stringify(err_2, null, 2)));
                                    return [3 /*break*/, 4];
                                case 4:
                                        ...
                                        taskListRes.tasks.forEach(function (task) { return __awaiter(_this, void 0, void 0, function () {
                                            ...
                                            return __generator(this, function (_a) {
                                                switch (_a.label) {
                                                    ...
                                                    case 3:
                                                        err_3 = _a.sent();
                                                        log("claimTask error ".concat(JSON.stringify(err_3, null, 2)));
                                                        console.log(err_3);
                                                        return [3 /*break*/, 4];
                                                    case 4:
                                                        _a.trys.push([4, 6, , 7]);
...
main();
//# sourceMappingURL=third_draft.js.map